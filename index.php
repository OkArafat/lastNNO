                ...
                <div class="row align-items-center">
                    ...
                    <div
                        ...
                        <ul
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll"
                                    href="#advisors_section"
                                    style="color: #222; font-weight: bold; font-size: 1em;">Advisors</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link click-scroll"
                                    href="#section_3"
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll"
                                href="#advisors_section">Advisors</a>
                        </li>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-12 mb-4 me-lg-4">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="images/Advisor/advisor.jpg"
                            ...
                            <div class="artists-hover">
                                ...
                                <p class="mb-0">
                                    ...
                                    <a
                                        href="https://scholar.google.com/citations?user=qC6VODEAAAAJ&hl=en">Dr.Sharmind Neelotpol</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-12 mb-4 ms-lg-4">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="images/Advisor/co.JPEG.jpg"
                                    class="artists-image img-fluid">
                            </div>
                            ...
                            <div class="artists-hover">
                                ...
                                <p class="mb-0">
                                    <strong>Contact Info:</strong>
                                    <a
                                        href="https://www.linkedin.com/in/oikya/?originalSubdomain=bd">Dr.Upal Aditya Oikya</a>
                                </p>
                            </div>
                        </div>
                    </div>
